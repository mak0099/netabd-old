    ...
    <div class="col-sm-12">
        <div class="box box-info">
            <div class="box-header">
                <h3>Add Announcement<a href="{{route('list_announcement')}}" class="btn bg-purple pull-right"><span class="ion-arrow-return-left"></span> Announcement List</a></h3>
            </div>
            <!-- /.box-header -->
            @include('partials/messages')
            <!-- form start -->
            <form role="form" action="{{route('save_announcement')}}" method="post">
                {{csrf_field()}}
                <div class="box-body">
