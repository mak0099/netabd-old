    ...
    <div class="col-sm-12">
        <div class="box box-info">
            <div class="box-header">
                <h3>Add News<a href="{{route('list_news')}}" class="btn bg-purple pull-right"><span class="ion-arrow-return-left"></span> News List</a></h3>
            </div>
            <!-- /.box-header -->
            @include('partials/messages')
            <!-- form start -->
            <form role="form" action="{{route('save_news')}}" method="post">
                {{csrf_field()}}
                <div class="box-body">
                    ...
                    <div class="form-group col-sm-12">
                        <label>News</label>
                        <div class="radio">
                            <label class="radio-inline"><input type="radio" name="publication_news" value="1" checked=""> Publish</label>
                            <label class="radio-inline"><input type="radio" name="publication_news" value="0"> Draft</label>
                        </div>
                    </div>
                </div>
